...
Figures~\ref{fig:newSpeedupHeat} and \ref{fig:oldSpeedupHeat} show speedup results produced from our tests for the two sets of hardware described in Section~\ref{parameters-section}. \revised{We also include direct results of time per timestep in Appendix~\ref{sec:add_figs} which aids discussion here. A black dot with a white border represents the worst case and a white dot with a black border represents the best case in all of the contours.}{revTwo}
