...
\begin{figure}[H]
    \widefigure
    \includegraphics[scale=0.9,trim={0.45cm 0.3cm 0.1cm 0.9cm},clip]{figs/heatValidate.pdf}
...
\begin{figure}[H]
    \widefigure
    \includegraphics[scale=0.9]{figs/speedUpheatNew.pdf}
...
\begin{figure}[H]
    \widefigure
    \includegraphics[scale=0.9]{figs/speedUpheatOld.pdf}
...
\begin{figure}[H]
\widefigure
    \includegraphics[scale=0.9,trim={0.45cm 0.3cm 0.1cm 0.9cm},clip]{figs/eulerValidate.pdf}
...
\begin{figure}[H]
\widefigure
    \includegraphics[scale=0.9]{figs/speedUpeulerNew.pdf}
...
\begin{figure}[H]
    \widefigure
    \includegraphics[scale=0.9]{figs/speedUpeulerOld.pdf}
...
\begin{figure}[H]
\widefigure
    \includegraphics[scale=0.9]{figs/weakScalabilityHeat.pdf}
...
\begin{figure}[H]
    \widefigure
    \includegraphics[scale=0.9]{figs/weakScalabilityEuler.pdf}
...
\begin{figure}[H]
\widefigure
    \includegraphics[scale=0.9]{figs/clockTimeSwepteulerOld.pdf}
